...
def get_config_u2l(train):
    conf = {
        ...
        'data_params': {
            ...
            # 原始Staqc打标签的词向量地址 'code_pretrain_emb_path':'../data/new_data_hnn/'+train+'/'+train+'_word_vocab_final
            # .pkl', 'text_pretrain_emb_path': '/home/gpu/RenQ/stqac/data/new_data_hnn/' + train +
            # '/'+train+'_word_vocab_final.pkl',
            ...
            'code_pretrain_emb_path': '../data_processing/hnn_process/ulabel_data/large_corpus'
                                      '/python_word_vocab_final.pkl',
            'text_pretrain_emb_path': '../data_processing/hnn_process/ulabel_data/large_corpus'
                                      '/python_word_vocab_final.pkl'
