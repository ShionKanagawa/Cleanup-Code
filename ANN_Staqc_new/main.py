...
def process_matrix(inputs, trans1_length, maxlen):
...
class StandoneCode:
    ...
    def get_data(self, path):
        ...
        text_blocks = process_matrix(np.array([samples_term[1] for samples_term in data]),
                                     text_block_length, 100)

        text_S1 = text_blocks[0]
        text_S2 = text_blocks[1]

        code_blocks = process_matrix(np.array([samples_term[2] for samples_term in data]),
